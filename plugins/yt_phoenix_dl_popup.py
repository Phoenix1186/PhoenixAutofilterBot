...
from database.phoenix_utils import  humanbytes
...
async def echo(client, message):
    ...
    if "youtu" in url or "youtube" in url:
        ...
        xPHOENIX_BAAPUx_d_size = requests.head(url)    
    ...
    namee = "undefined" if "youtu" in url or "youtube" in url else xPHOENIX_BAAPUx_u_name
