...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/ph0enix_web/PhoenixAutofilterBot/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/ph0enix_web')
                            ]
                        ]
                    )
                    )
    ...
    if data.startswith("sendfiles"):
        ...
        # print('Help phoenix bhai ! i am hit')
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        ...
        if result.deleted_count:
            ...
            # files indexed before https://github.com/ph0enix_web/PhoenixAutofilterBot/commit/f3d2a1bcb155faf44178e5d7a685a1b533e714bf#diff-86b613edf1748372103e94cacff3b578b36b698ef9c16817bb98fe9ef22fb669R39 
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You ph0enix_web ♥️')
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/PhoenixTutorialLink/23</code></b>")
