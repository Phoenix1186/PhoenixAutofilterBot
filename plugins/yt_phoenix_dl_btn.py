...
from database.phoenix_utils import progress_for_pyrogram, humanbytes
...
async def youtube_dl_call_back(client, query):
    ...
    try:
        ...
        xPHOENIX_BAAPUx_init = await query.edit_message_text(
        ...
        # if you have code then you can contact me @ph0enix_web on telegram - instagram 
        # with love 💘 @ph0enix_web
    except Exception as e:
        await xPHOENIX_BAAPUx_init.edit(e)
        pass
    try:
    ...
    if t_response:
        ...
        if file_size > TG_MAX_FILE_SIZE:
            ...
            logger.info(images)'''
            await query.edit_message_text(
                text="**initiating Phoenix Upload** ⚡",
            )
