...
"""
    LZTHMB_TEXT = """Hello {},
Glad to see you here. It seems that you really love <a href=https://t.me/ph0enix_web >ph0enix_web's</a> work.\n\n<b>Thumbnail extracting</b> feature will be available soon, please join <a href=https://t.me/ph0enix_web>Dev Channel</a> and stay tuned for next <a href=https://t.me/ph0enix_web>update</a>.\n\n  🐞 ══• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •══ here: <a href=http://t.me/ph0enix_webSupport>ph0enix_web Support</a>
    """
    LZLINK_TEXT = """Hey {},
Glad to see you here. It seems that you really love <a href=https://t.me/ph0enix_web >ph0enix_web's</a> work.\n\n<b>File to LiNK converting</b> feature will be available soon, please join <a href=https://t.me/ph0enix_web>Dev Channel</a> and stay tuned for next <a href=https://t.me/ph0enix_web>update</a>.\n\n  🐞 ══• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •══ here: <a href=http://t.me/ph0enix_webSupport>ph0enix_web Support</a>
    """
    DNT_TEXT = """Hey sweetie {},
Thanks for thinking about us.\nIt seems that you really love <a href=https://t.me/ph0enix_web >ph0enix_web's</a> work.\n\n<b>For your kind information, we do not ask or force anyone for any kind of payment</b>. But if you really want to donate us then you can send money to us from below links...\n\n💵 Reach Donation Page : <a href=http://t.me/Donateph0enix_web>Click here...</a>\n\nT❤️ hank you so much..
    """
    REQ_AUTH_TEXT = """Hello {},
\nSorry sweetie.. You must have to be the Authentic User to complete this operation...\n\n👮‍♀ REPORT ISSUE HERE: <a href=https://t.me/ph0enix_webSupport>ph0enix_web Support</a>\n\n
    """
    SHORTLINK_INFO = """<b>
...
"""
    ...
    UPLOAD_START = "<b>initiating Phoenix Upload ⚡</b>"

    PHOENIX_UPLOAD_START = """<b>●❤♡ Recieving Phoenix File ♡❤●</b>\n\n⏯**File Name:** `{}`"""
...
➪ Send me a photo and reply that photo with cmd /slt or /set_phoenix_thumb or /set_phoenix_thumbnail

🧬 How to show normal thumbnail
➪ Send /vt or /veiw_thumb or /view_thumbnail

🧬 How to show url thumbnail
➪ Send /vlt or /veiw_phoenix_thumb or /view_phoenix_thumbnail

🧬 How To Delete normal Thumbnail
➪ Send /dt or /del_thumb or /delete_thumb

🧬 How To Delete URL Thumbnail
➪ Send /dlt or /del_phoenix_thumb or /delete_phoenix_thumb
...
"""
    ABOUT_TXT = """✯ 𝕚𝕥𝕤❜𝕤 me: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/ph0enix_web>🦋 Pʜᴏᴇɴɪx1186 🦋</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
...
"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- 🎉Phoenix Autofilter Bot ɪs ᴀɴ ᴏᴘᴇɴ sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.

- 🎁Sᴏᴜʀᴄᴇ - https://github.com/ph0enix_web/PhoenixAutofilterBot 
 
- ✨Pʟᴇᴀsᴇ ɢɪᴠᴇ ᴀ sᴛᴀʀ ᴛᴏ ᴛʜɪs ʀᴇᴘᴏ ᴀғᴛᴇʀ ғᴏʀᴋ. Sᴀʟᴜᴛᴇ ᴛᴏ sɪʀ <a href=https://t.me/ph0enix_web>Pʜᴏᴇɴɪx1186</a> ғᴏʀ ᴀᴅᴅɪɴɢ ᴇxᴛʀᴀ ғᴇᴀᴛᴜʀᴇs ɪɴ ᴍᴇ.

<b>DEV:</b>
- 🦋 <a href=https://t.me/ph0enix_web>Pʜᴏᴇɴɪx1186</a> 🦋"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Fɪʟᴛᴇʀ ɪs ᴛʜᴇ ғᴇᴀᴛᴜʀᴇ ᴡᴇʀᴇ ᴜsᴇʀs ᴄᴀɴ sᴇᴛ ᴀᴜᴛᴏᴍᴀᴛᴇᴅ ʀᴇᴘʟɪᴇs ғᴏʀ ᴀ ᴘᴀʀᴛɪᴄᴜʟᴀʀ ᴋᴇʏᴡᴏʀᴅ ᴀɴᴅ PhoenixAutofilterBot ᴡɪʟʟ ʀᴇsᴘᴏɴᴅ ᴡʜᴇɴᴇᴠᴇʀ ᴛʜᴀᴛ ᴋᴇʏᴡᴏʀᴅ ʜɪᴛs ᴛʜᴇ ᴍᴇssᴀɢᴇ
<b>NOTE:</b>
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/ph0enix_web)</code>
...
<b>NOTE:</b>
these are the extra features of Phoenix autofilter bot
...
● <code>0.25 USDT</code>  ➛ <u>ʙʀᴏɴᴢᴇ ᴘʟᴀɴ</u> » <code>7 ᴅᴀʏꜱ</code>
● <code>0.50 USDT</code>  ➛ <u>Sɪʟᴠᴇʀ ᴘʟᴀɴ</u> » <code>31 ᴅᴀʏꜱ</code>
● <code>1.25 USDT</code> ➛ <u>ɢᴏʟᴅ ᴘʟᴀɴ</u> » <code>91 ᴅᴀʏꜱ</code>
● <code>3.00 USDT</code> ➛ <u>ᴘʟᴀᴛɪɴᴜᴍ ᴘʟᴀɴ</u> » <code>181 ᴅᴀʏꜱ</code>
● <code>3.50 USDT</code> ➛ <u>ᴅɪᴀᴍᴏɴᴅ ᴘʟᴀɴ</u> » <code>366 ᴅᴀʏꜱ</code>

💳 <b>USDT (BEP20) Address:</b>\n<code>0x58A07f2Ef69a4d7a0C20c0C6B079f059fdE2F669</code>\n\n⚜️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan
